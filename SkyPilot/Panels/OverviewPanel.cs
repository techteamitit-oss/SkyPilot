...
/// <summary>
/// Modern overview with circular gauges, stat cards, compass and minimap.
...
public class OverviewPanel : UserControl
{
    ...
    // Compass & Minimap (child controls, draggable)
    ...
    public OverviewPanel()
    {
        ...
        _compass = new CompassWidget { Size = new Size(120, 120), BackColor = ModernTheme.Background };
        _compass.MouseDown += OnDragStart;
        _compass.MouseMove += OnDragMove;
        _compass.MouseUp += OnDragEnd;
        Controls.Add(_compass);

        _miniMap = new MiniMapControl { Size = new Size(240, 240) };
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        {
            int cardY = 190;
            int cardW = Math.Min(200, (Width - 60) / 3);
            int cardH = 80;
            int cardGap = 10;
